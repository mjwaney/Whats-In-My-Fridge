...
<div class="panel panel-default">
    <div class="panel-heading">Login with Social Media</div>
        <div class="panel-body">         
            <center><a href="/" class="btn btn-block btn-lg btn-social btn-google social-button"><span class="fa fa-google"></span>Login with Google+</a></center>
...
{{ action('Auth\LoginController@auth', ['provider' => 'google']) }}
